...
#                     drive(-slow,slow,-slow,slow)
    ...
    #                     print("Centered")
                        ...
                        while front_left_us > 8 or front_right_us > 8:
...
#         print("Received data: 0: {}, 1: {}, 2: {}, 3: {}, 4: {}".format(data[0], data[1], data[2], data[3], data[4])) 
        ...
        det_c = data[4] % 10
        data[4] = data[4] / 10
        if -11 <= data[0] <= -5 and data[4] >= 180: # -15 -5  data[1] >= -45
            data[0] = 0
            data[1] = 0
            data[2] = 0
            data[3] = 0
...
#             print("Drive stat 2")
        ...
        elif data[0] < -11 and data[4] >= 180:  # ANTICLOCK
            data[0] = -7.7 # 6
            data[1] = 7.7
            data[2] = -7.7
            data[3] = 7.7
        elif -5 < data[0] and data[4] >= 180:  # CLOCK
            data[0] = 7.7
            data[1] = -7.7
            data[2] = 7.7
            data[3] = -7.7
