...
# For ibus receive then only RX pin needs to bet connected
...
class IBus ():
    ...
    def __init__ (self, uart_num, baud=115200, num_channels=6): #CHANGE THE NUMBER OF CHANNEL ACCORDING TO THE RECEIVER
        self.uart_num = uart_num
        self.baud = baud
        self.uart = UART(self.uart_num, self.baud, tx= Pin(8), rx = Pin(9))
